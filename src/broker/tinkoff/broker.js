...
export const options = [
    ...
    { flags: "--print-balance", description: "Print balance and positions (real by default; sandbox with --sandbox)", default: false },
    { flags: "--print-history", description: "Print operations history for --account (real by default; sandbox with --sandbox)", default: false },
